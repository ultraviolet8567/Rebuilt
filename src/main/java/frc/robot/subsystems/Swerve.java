...
public class Swerve extends SubsystemBase {
    ...
    public void periodic() {
        ...
        Logger.recordOutput(
                "Swerve/BackLeft/AbsoluteEncoderAngle", (backLeft.getAbsoluteEncoderAngle()));
        Logger.recordOutput(
                "Swerve/BackRight/AbsoluteEncoderAngle", (backRight.getAbsoluteEncoderAngle()));

        Logger.recordOutput("Swerve/FrontLeft/DriveVelocity", (frontLeft.getDriveVelocity()));
        Logger.recordOutput("Swerve/FrontRight/DriveVelocity", (frontRight.getDriveVelocity()));
        Logger.recordOutput("Swerve/BackLeft/DriveVelocity", (backLeft.getDriveVelocity()));
        Logger.recordOutput("Swerve/BackRight/DriveVelocity", (backRight.getDriveVelocity()));

        Logger.recordOutput("Swerve/FrontLeft/DriveVoltage", Math.abs(frontLeft.getDriveVoltage()));
        Logger.recordOutput(
    ...
    public double solveBodyRot(Pose2d robotPose, Translation3d targetPose) {
        return Math.atan2(
                targetPose.getY() - robotPose.getY(), targetPose.getX() - robotPose.getX());
    }
